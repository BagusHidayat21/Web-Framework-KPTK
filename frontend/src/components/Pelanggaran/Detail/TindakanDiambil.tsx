        ...
        <div className="pt-4 border-t">
          <Dialog open={props.isEditModalOpen} onOpenChange={props.setIsEditModalOpen}>
            ...
            <DialogContent className="w-[95vw] max-w-md max-h-[90vh] overflow-y-auto">
              <DialogHeader>
                <DialogTitle className="text-lg text-blue-600">Update Tindakan</DialogTitle>
              </DialogHeader>
              <div className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="action">Tindakan Baru</Label>
                  <Textarea id="action" value={props.formData.action} onChange={(e) => props.handleInputChange("action", e.target.value)} placeholder="Masukkan tindakan yang akan diambil" className="min-h-[80px]" />
                </div>
                <div className="space-y-2">
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-4">
                  ...
                  <Button variant="outline" onClick={() => props.setIsEditModalOpen(false)} className="h-11 flex-1">Batal</Button>
                </div>
              </div>
            </DialogContent>
          </Dialog>
