  ...
  const handleSubmit = async() => {
    try {
      ...
      if (response.status === 200) {
        ...
        alert('Login Gagal. Periksa Kembali Akun dan Password Anda');
      }
    } catch (error) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
            ...
            <div className="space-y-6">
              ...
              <div className="text-center">
                <p className="text-sm text-gray-600">
                  ...
                  <a href="/auth/register" className="ml-1 text-blue-600 hover:text-blue-700 font-medium transition-colors">
                    Sign up
                  </a>
                </p>
              </div>
        ...
        <div className="text-center mt-8 text-sm text-gray-500">
          <p>By signing in, you agree to our <a href="#" className="text-blue-600 hover:text-blue-700">Terms of Service</a> and <a href="#" className="text-blue-600 hover:text-blue-700">Privacy Policy</a></p>
        </div>
      </div>
    </div>
  );
